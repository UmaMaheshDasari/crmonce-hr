...
router.get('/jobs', requireAnyPermission('payroll.process'), async (req, res, next) => {
...
router.get('/jobs/:id', requireAnyPermission('payroll.process'), async (req, res, next) => {
...
router.post('/run', requireAnyPermission('payroll.process'), async (req, res, next) => {
  try {
...
router.post('/jobs/:id/retry', requireAnyPermission('payroll.process'), async (req, res, next) => {
...
router.delete('/jobs/:id', requireAnyPermission('payroll.process'), async (req, res, next) => {
