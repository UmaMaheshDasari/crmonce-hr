...
const STYLE = {
  ...
  device_checkin:        { icon: '🖥️', dot: 'bg-emerald-500', ring: 'ring-emerald-500/20' },
  device_checkout:       { icon: '🖥️', dot: 'bg-blue-500',    ring: 'ring-blue-500/20' },
  auto_checkout:         { icon: '⏱️', dot: 'bg-orange-500',  ring: 'ring-orange-500/20' },
  attendance_correction: { icon: '📝', dot: 'bg-amber-500',   ring: 'ring-amber-500/20' },
  correction_submitted:  { icon: '📝', dot: 'bg-amber-500',   ring: 'ring-amber-500/20' },
  correction_approved:   { icon: '✅', dot: 'bg-emerald-500', ring: 'ring-emerald-500/20' },
  correction_rejected:   { icon: '❌', dot: 'bg-red-500',     ring: 'ring-red-500/20' },
  employee_updated:      { icon: '👤', dot: 'bg-violet-500',  ring: 'ring-violet-500/20' },
